                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-cogs"></i> Site Ayarlari <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="genel-ayar.php">Genel Ayarlar</a></li>
                                    <li><a href="iletisim-ayarlar.php">Iletisim Ayarlar</a></li>
                            ...
                            <li>
                                <a href="kullanici.php">
                                    <i class="fa fa-user"></i> Kullanicilar
                                </a>
                            </li>
                            <li>
                                <a href="yorumlar.php">
                            ...
                            <li>
                                <a href="urun.php">
                                    <i class="fa fa-shopping-cart"></i> Urunler
                                </a>
                            </li>
                            <li>
                                <a href="menu.php">
                                    <i class="fa fa-list"></i> Menular
                                </a>
                            </li>
                            <li>
                                <a href="kategori.php">
                                    <i class="fa fa-keyboard-o"></i> Kategori
                                </a>
                            </li>
                            <li>
                                <a href="slider.php">
