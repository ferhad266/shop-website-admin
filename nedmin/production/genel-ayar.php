                        ...
                        <div class="x_content">
                            ...
                            <form action="../netting/islem.php" method="post" id="demo-form2" data-parsley-validate
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" name="ayar_title" id="first-name"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" name="ayar_description" id="first-name"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" name="ayar_keywords" id="first-name"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" name="ayar_author" id="first-name"
                                ...
                                <div class="form-group">
                                    <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                        <button type="submit" name="genelayarkaydet" class="btn btn-success">Guncelle
                                        </button>
                                    </div>
                                </div>
