    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3"><!--footer Share-->
                ...
                <div class="fsoc">
                    <a href="http://<?php echo $ayarcek['ayar_twitter'];?>" target="_blank" class="ftwitter">twitter</a>
                    <a href="http://<?php echo $ayarcek['ayar_facebook'];?>" target="_blank" class="ffacebook">facebook</a>
                    <a href="http://<?php echo $ayarcek['ayar_youtube'];?>" target="_blank" class="fflickr">Youtube</a>
                    <a href="http://<?php echo $ayarcek['ayar_google'];?>" target="_blank" class="ffeed">google</a>
                    <div class="clearfix"></div>
                </div>
                <div class="clearfix"></div>
            </div><!--footer Share-->
