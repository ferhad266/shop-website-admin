    ...
    <div class="f-widget featpro">
        <div class="container">
            <div class="title-widget-bg">
                <div class="title-widget">One Cixan Urunler</div>
                        ...
                        <div class="productwrap">
                            <div class="pr-img">
                                ...
                                <div class="pricetag blue">
                                    <div class="inner"><span><?= $uruncek['urun_fiyat']; ?></span></div>
                                </div>
                            </div>
                            <span class="smalltitle"><a href="urun-<?=seo($uruncek["urun_ad"]).'-'.$uruncek["urun_id"]?>"><?= $uruncek['urun_ad']; ?></a></span>
                            <span class="smalldesc">Urun kodu: <?= $uruncek['urun_id']; ?></span>
                        </div>
                    </div>
                <?php } ?>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9"><!--Main content-->
                ...
                <a href="hakkimizda" class="btn btn-default btn-red btn-sm">Devamini oku</a>
